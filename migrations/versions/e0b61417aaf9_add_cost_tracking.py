...
Revision ID: e0b61417aaf9
Revises: f045fb665941
Create Date: 2026-06-18 06:09:23.714341
...
revision: str = 'e0b61417aaf9'
down_revision: Union[str, None] = 'f045fb665941'
...
def upgrade() -> None:
    ...
    op.add_column('conversations', sa.Column('total_token', sa.Integer(), server_default='0', nullable=False))
    op.add_column('conversations', sa.Column('total_cost', sa.Float(), server_default='0.0', nullable=False))
    op.add_column('messages', sa.Column('cost', sa.Float(), server_default='0.0', nullable=False))
...
def downgrade() -> None:
    ...
    op.drop_column('conversations', 'total_token')
