"""Add source_id and fingerprint to knowledge_base_documents

Revision ID: 4f2ae5561031
Revises: 4296fc775606
Create Date: 2026-06-11 22:44:55.904668
...
revision: str = '4f2ae5561031'
down_revision: Union[str, None] = '4296fc775606'
...
def upgrade() -> None:
    ...
    op.add_column('knowledge_base_documents', sa.Column('source_id', sa.String(length=255), nullable=True))
    op.add_column('knowledge_base_documents', sa.Column('fingerprint', sa.String(length=64), nullable=True))
    op.create_unique_constraint(None, 'knowledge_base_documents', ['source_id'])
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint(None, 'knowledge_base_documents', type_='unique')
    op.drop_column('knowledge_base_documents', 'fingerprint')
